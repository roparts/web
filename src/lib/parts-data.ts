...
export const partsData: Part[] = [
  ...
  {
    id: 'ROP-0011',
    name: 'Kent Gold Membrane 80GPD',
    name_hi: 'केंट गोल्ड मेम्ब्रेन 80GPD',
    price: 2800,
    discountPrice: 2550,
    description: 'Genuine Kent Gold membrane for superior performance and reliability. Ensures safe and pure drinking water.',
    description_hi: 'बेहतर प्रदर्शन और विश्वसनीयता के लिए असली केंट गोल्ड मेम्ब्रेन। सुरक्षित और शुद्ध पेयजल सुनिश्चित करता है।',
  ...
  },
  {
    ...
    price: 650,
    description: 'Official AquaGuard sediment filter with G-Tech for advanced purification and long life.',
    description_hi: 'उन्नत शुद्धिकरण और लंबे जीवन के लिए जी-टेक के साथ आधिकारिक एक्वागार्ड सेडिमेंट फ़िल्टर।',
    image: 'https://placehold.co/620x620.png',
    category: 'Filters',
    category_hi: 'फ़िल्टर',
  ...
  },
  {
    ...
    price: 300,
    description: '10-meter roll of high-quality, food-grade 1/4 inch RO pipe. Flexible and durable for all RO systems.',
    description_hi: 'उच्च-गुणवत्ता, खाद्य-ग्रेड 1/4 इंच आरओ पाइप का 10-मीटर रोल। सभी आरओ सिस्टम के लिए लचीला और टिकाऊ।',
    image: 'https://placehold.co/630x630.png',
    category: 'Fittings',
    category_hi: 'फिटिंग्स',
  ...
  ...Array.from({ length: 90 }, (_, i) => {
    const id = i + 15; // Start from ROP-0015
